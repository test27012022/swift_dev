...
class ResultView: UIView {
    ...
    private let totalBillView: AmountView = {
        let view = AmountView(
            title: "Total bill",
            textAlignment: .left,
            amountLabelIdentyfier: ScreenIdentifier.ResultView.totalBillValueLabel.rawValue)
        return view
    }()
    ...
    private let totalTipView: AmountView = {
        let view = AmountView(
            title: "Total tip",
            textAlignment: .right,
            amountLabelIdentyfier: ScreenIdentifier.ResultView.totalTipValueLabel.rawValue)
        return view
    }()
